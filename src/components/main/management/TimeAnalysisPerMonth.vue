<template>
  <div id="time-analysis-per-month">
    <el-car>
      <div id="bar-chart-month">
        <el-row :gutter="20">
          <el-col :span="7" :offset="1">
            <el-date-picker type ="month" placeholder="选择月份"></el-date-picker>
          </el-col>
          <el-col :span="6" :offset="2">
            <el-input :value="'Total: ' + totalTime" :disabled="true" placeholder="Total:"></el-input>
          </el-col>
          <el-col :span="6" :offset="1">
            <el-input :value="'AVG: ' + (totalTime / (chartData.filter(x => Number.parseInt(x) !== 0).length)).toFixed(1)" :disabled="true" placeholder="AVG:"></el-input>
          </el-col>
        </el-row>
      </div>
    </el-car>
    ...
    drawChart () {
      let option = {
        ...
        series: [{
          ...
          itemStyle: {
            normal: {
              color: new Echarts.grahpic.LinearGradient(0, 0, 0, 1, [
...
#time-analysis-by-type #bar-chart-month
{
  width: 100%;
  height: 240px
}
